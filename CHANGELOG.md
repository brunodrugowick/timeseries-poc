...
## [1.2.0]
### Added
- Use more vertical space, avoids breaking numbers and text on the widgets.

## [1.1.4]
### Fixed
- Heart rate should not be null.
...
## [1.1.1]
### Fixed
- UUID is now used as ID also for measurements. It's important because I needed to import old data.

## [1.1.0]
### Added
- Added "Detailed Data" button to Snapshots (that was quite easy by the way!).
